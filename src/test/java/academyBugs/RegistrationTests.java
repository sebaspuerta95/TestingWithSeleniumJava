...
public class RegistrationTests extends BaseAB {
    ...
    @Test (priority = 1, dataProvider = "csvDataProvider", dataProviderClass = SupplierClass.class)
    ...
    @Test (priority = 2, dataProvider = "testDataSupplier", dataProviderClass = SupplierClass.class)
